...
export default function ForcastFooter() {
  ...
  return (
    <div className="sticky bottom-1 left-0 w-full">
      <div className=" dark:bg-[rgba(25,27,31)] bg-cyan-900 dark rounded-3xl flex items-center justify-between pr-4">
        <div className="flex items-center">
          ...
          <div className="text-sm font-thin">
            ...
            <h3 className="text-ellipsis whitespace-nowrap">
              {weatherDecoder[weather?.daily.weathercode[1] as number]}
            </h3>
          </div>
        </div>
        <div className="w-1/3">
